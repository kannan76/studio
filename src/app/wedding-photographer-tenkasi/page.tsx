...
export const metadata: Metadata = {
  title:
    "Wedding Photographer in Tenkasi | Smile Pic Photography",
  description:
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-24">
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
        ...
        Alangulam and across Tenkasi district, our team ensures every moment
        is beautifully documented with creativity and precision.
      </p>
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
        ...
        Whether your wedding is at a temple, marriage hall, or outdoor venue
        in Tenkasi, we capture authentic emotions that last a lifetime.
      </p>
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-8">
        ...
        Tirunelveli, Alangulam, or Courtallam, contact Smile Pic Photography
